...
<p>The same wellhead, capped since mid-2025 and now fitted with a valve, measured against a tape for scale during a routine follow-up visit roughly seven months after the eruption; not a new capping event, just a later inspection of the same structure.</p>

<video controls preload="metadata" class="timeline-video">

<source src="assets/video_compressed/20260122_steaming_fissure.mp4" type="video/mp4">

Your browser does not support embedded video.

</video>

<p>The steaming fissure with bubbling mud pots and intermittent spouting, recorded the same day, direct evidence that the outflow feature was still actively venting more than half a year after the initial eruption.</p>
